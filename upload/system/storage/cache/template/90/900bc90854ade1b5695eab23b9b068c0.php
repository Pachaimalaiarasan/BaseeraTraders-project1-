...
class __TwigTemplate_460dabff2b7b9cb2baa8b2696bcd4739 extends Template
{
    private $source;
    private $macros = [];
...
function addOptionValue() {
  ...
  ";
    ...
    html += '      <div class=\"input-group-text\"><img src=\"";
            // line 136
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["language"], "image", [], "any", false, false, false, 136), "js");
            echo "\" title=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["language"], "name", [], "any", false, false, false, 136), "js");
            echo "\" /></div>';
...
";
    ...
    {
        return new Source("", "admin/view/template/catalog/option_form.twig", "C:\\xampp\\htdocs\\BaseeraTraders\\BaseeraTraders-project1-\\upload\\admin\\view\\template\\catalog\\option_form.twig");
    }
}
